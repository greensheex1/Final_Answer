...
#chromedriver version: 127.0.6533.72
...
for detail_url in detail_page_url_list:
    ...
    #get mail address
    try:
        mail = driver.find_element(by=By.LINK_TEXT, value="お店に直接メールする").get_attribute('href').split(':')[1]
    except:
        mail = ''
...
df.to_csv('1-2test.csv', encoding='cp932')